...
.LFE1526:
	...
	.globl	_Z11timer_startv
	.type	_Z11timer_startv, @function
_Z11timer_startv:
.LFB1527:
	.cfi_startproc
	endbr64
...
.L17:
	...
	.cfi_endproc
.LFE1527:
	.size	_Z11timer_startv, .-_Z11timer_startv
	.globl	_Z9timer_end8timespec
	.type	_Z9timer_end8timespec, @function
_Z9timer_end8timespec:
.LFB1528:
	.cfi_startproc
	endbr64
	pushq	%rbp
...
.L20:
	...
	.cfi_endproc
.LFE1528:
	.size	_Z9timer_end8timespec, .-_Z9timer_end8timespec
	.section	.rodata
.LC2:
...
.LC3:
	.string	"Sorting "
.LC4:
	.string	" elements took "
.LC5:
	.string	" ns"
	.align 8
.LC6:
	.string	"Data consistency check failed!"
	.text
	.globl	main
	.type	main, @function
main:
...
.L26:
	...
	jmp	.L26
.L25:
	call	_Z11timer_startv
	movq	%rax, -112(%rbp)
	movq	%rdx, -104(%rbp)
	call	_Z12papito_startv@PLT
	movl	-140(%rbp), %eax
	leal	-1(%rax), %edx
	movq	-128(%rbp), %rax
	movl	$0, %esi
	movq	%rax, %rdi
	call	_Z9quickSortPiii
	call	_Z10papito_endv@PLT
	movq	-112(%rbp), %rdx
	movq	-104(%rbp), %rax
	movq	%rdx, %rdi
	movq	%rax, %rsi
	call	_Z9timer_end8timespec
	movq	%rax, -120(%rbp)
	leaq	.LC3(%rip), %rsi
	leaq	_ZSt4cout(%rip), %rdi
	call	_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc@PLT
...
.LLSDACSB1529:
	.uleb128 .LEHB0-.LFB1529
	.uleb128 .LEHE0-.LEHB0
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB1-.LFB1529
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L35-.LFB1529
	.uleb128 0
	.uleb128 .LEHB2-.LFB1529
	.uleb128 .LEHE2-.LEHB2
	.uleb128 .L36-.LFB1529
	.uleb128 0
	.uleb128 .LEHB3-.LFB1529
	.uleb128 .LEHE3-.LEHB3
	.uleb128 0
	.uleb128 0
.LLSDACSE1529:
